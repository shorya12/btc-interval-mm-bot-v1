...
rpc_url = "https://polygon-mainnet.g.alchemy.com/v2/sPXfpsHtrLgfEO3eZL5KL" # Polygon rpc url 
priv_key = os.getenv("POLYBOT_PRIVATE_KEY") # Polygon account private key (needs some MATIC)
pub_key = "0x86E35744AEAe5E693df6FbE02FF91AA566955DCc" # Polygon account public key corresponding to private key
